...
const pendingHtml = `                const card = \\\`
                  <div class="match-card" style="border: 2px solid var(--primary-blue); grid-column: 1 / -1; max-width: 650px; margin: 0 auto; box-shadow: 0 10px 25px rgba(229, 43, 53, 0.1); display: flex; flex-direction: column; align-items: center; text-align: center; padding: 3rem 2rem;">
                    
                    <div style="width: 64px; height: 64px; border-radius: 50%; background-color: #FFF1F2; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem;">
